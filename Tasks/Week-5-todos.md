...
#### Learning Resources
- [ ] Read [Linux Troubleshooting](https://www.billdietrich.me/LinuxTroubleshooting.html) - General Linux debugging reference
- [ ] Read [Linux Networking Troubleshooting](https://www.billdietrich.me/LinuxNetworking.html#Troubleshooting) - Bill Dietrich's comprehensive guide
- [ ] Read [Linux Network Troubleshooting Guide](https://www.redhat.com/sysadmin/beginners-guide-network-troubleshooting-linux) - Red Hat's beginner guide
- [ ] Read [How to Troubleshoot Your Network on Linux](https://www.freecodecamp.org/news/how-troubleshoot-network-on-linux/) - freeCodeCamp's OSI model approach
...
#### Learning Resources
- [ ] Read [How to Use Traceroute and MTR](https://www.digitalocean.com/community/tutorials/how-to-use-traceroute-and-mtr-to-diagnose-network-issues) - DigitalOcean's comprehensive guide
- [ ] Read [What is traceroute?](https://www.cloudflare.com/learning/network-layer/what-is-traceroute/) - Cloudflare's breakdown
- [ ] Read [What is MTR?](https://www.cloudflare.com/learning/network-layer/what-is-mtr/) - Cloudflare explains mtr

#### Practice Goals
- [ ] Open a terminal and try basic ping:
  - [ ] `ping google.com` - Does it respond?
  - [ ] `ping -c 4 8.8.8.8` - Ping by IP (bypasses DNS)
  - [ ] `ping -c 4 localhost` - Ping yourself
- [ ] Trace the network path:
  - [ ] `traceroute google.com` - See the hops
  - [ ] Notice where latency increases
  - [ ] Try `mtr google.com` if installed (combines ping + traceroute, press `q` to quit)
- [ ] Test a failing scenario:
  - [ ] `ping nonexistent.invalid` - See what DNS failure looks like
...
#### Learning Resources
- [ ] Read [How to Use the dig Command](https://www.learnlinux.tv/how-to-use-the-dig-command-in-linux-dns-lookup-tutorial/) - LearnLinuxTV guide
- [ ] Read [dig Command Examples](https://www.madboa.com/geek/dig/) - Comprehensive reference
- [ ] Read [Linux dig Command Examples](https://www.cyberciti.biz/faq/linux-unix-dig-command-examples-usage-syntax/) - nixCraft guide

#### Practice Goals
- [ ] Practice basic DNS lookups:
...
- [ ] Query specific DNS servers:
  ...
  - [ ] Compare results - are they the same?
