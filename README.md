...
3. **You're Ready!**
   - The vault will open to the [[Home|🏠 Home page]] automatically
   - **Wizards:** Navigate to your personal Grimoire from the Home page
   - **Mentors:** Access the [[📚 Wizards MOC|Wizards Dashboard]] from the Home page

---

## Next Steps

Once the vault is set up, visit the [[Home|🏠 Home page]] for:
- Quick navigation to all dashboards and grimoires
- Program overview and learning philosophy
- Getting started guides for wizards and mentors
- Tips for success and important links
